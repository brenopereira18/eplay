...
const Checkout = () => {
  ...
  const form = useFormik({
    initialValues: {
      // passa os campos com seus valores
      fullName: '',
      email: '',
      cpf: '',
      deliveryEmail: '',
            ...
            <>
              <Row>
                ...
                <InputGroup>
                  ...
                  />
                  <small>
                    {getErrorMenssage('cpfCardOwner', form.errors.cpfCardOwner)}
                  </small>
                </InputGroup>
              </Row>
              <Row marginTop="24px">
                ...
                <InputGroup maxWidth="123px">
                  ...
                  />
                  <small>
                    {getErrorMenssage('expiresMonth', form.errors.expiresMonth)}
                  </small>
                </InputGroup>
                <InputGroup maxWidth="123px">
              ...
              <Row marginTop="24px;">
                <InputGroup maxWidth="140px">
                  ...
                  <small>
                    {getErrorMenssage('installments', form.errors.installments)}
                  </small>
                </InputGroup>
              </Row>
            </>
